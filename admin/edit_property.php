              ...
              <form action="edit_property_.php" method="post" enctype="multipart/form-data" class="adminForm">
                ...
                <table cellpadding="0" cellspacing="0" class="adminTable">
                  ...
                  <tr>
                    ...
                    <td align="left">
                      <input type="text" class="adminInput" id="property_lease_contact[][name]" value="<?php echo $lease_contact[1]['name'];?>" name="property_lease_contact[1][name]" />
                    </td>
                  </tr>
                  <tr>
                    <td align="right">
                    ...
                    <td align="left">
                      <input type="text" class="adminInput" id="property_lease_contact[][email]"  value="<?php echo $lease_contact[1]['email'];?>" name="property_lease_contact[1][email]" />
                    </td>
                  </tr>
                  <tr>
                    <td align="right">
                    ...
                    <td align="right">
                      <input type="text" class="adminInput" id="property_lease_contact[][name]" value="<?php echo $lease_contact[2]['name'];?>" name="property_lease_contact[2][name]" />
                    </td>
                  </tr>
                  <tr>
                    <td align="right">
                    ...
                    <td align="left">
                      <input type="text" class="adminInput" id="property_lease_contact[][email]" value="<?php echo $lease_contact[2]['email'];?>" name="property_lease_contact[2][email]" />
                    </td>
                  </tr>
                  <tr>
                    <td align="right">
                  ...
                  <tr>
                    ...
                    <td align="left">
                      <?php
                        if(!is_null($r['property_area_map'])) {
                      ?>
                          <img src="../prop_downloads/<?php echo $r['property_id'] . "_" .  $r['property_area_map'];?>" width="150" /> <input type="button" value="Delete?" onclick="delete_image('property_area_map');" /><br/>                          
                      <?php
                        } else {
                      ?>
                  ...
                  <tr>
                    ...
                    <td align="left">
                      <?php
                        if(!is_null($r['property_demog'])) {
                      ?>
                          <img src="../prop_downloads/<?php echo $r['property_id'] . "_" .  $r['property_demog'];?>" width="150" /> <input type="button" value="Delete?" onclick="delete_image('property_demog');" /><br/>                          
                      <?php
                        } else {
                      ?>
