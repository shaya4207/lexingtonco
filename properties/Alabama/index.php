  ...
  <div id="center">
    <div class="text" style="min-height:850px;">
      ...
      <div class="Prlist" style="margin-top:140px;">
        <div class="img style="margin-top:50px;""><img src="../../images/Properties/countryclub/countryclub_list_img.gif" width="120" height="97" alt="Country Club" /> </div>
        <span class="blue" style="color:#f1b8bca;"><a href="properties_countryclub.php">Country Club Centre</a></span><br/>
        1700 Carter Hill Road, Montgomery, AL<br/>
        <br/>
        Anchor Stores: Winn Dixie<br/>
        Property Type: Neighborhood<br/>
        <br/>
        <br/>
        <span class="bold" style="font-size:11px;">Leasing Contact:</span> <span style="font-size:11px;">Alan Retkinski, Ira Einhorn, <a href="mailto:alan@lexingtonco.com">Alan@lexingtonco.com</a>, <a href="mailto:ira@lexingtonco.com">Ira@lexingtonco.com</a></span> </div>
